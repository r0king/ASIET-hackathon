          ...
          <div className="col-span-full sm:col-span-3 md:col-span-2 mx-auto py-8 sm:py-16 px-3 flex flex-col">
            ...
            <div className="mt-8 sm:mt-16 flex items-center">
              ...
              <div className="ml-3 flex space-x-2">
                {/* :::facebook */}
                <a href="#facebook" className="p-1 inline-flex justify-center items-center text-[var(--primary-color)] hover:text-blue-400">
                ...
                {/* :::twitter */}
                <a href="#twitter" className="m-2 p-1 inline-flex justify-center items-center text-[var(--primary-color)] hover:text-blue-400">
                ...
                {/* :::intagram */}
                <a href="#instagrap" className="m-2 p-1 inline-flex justify-center items-center text-[var(--primary-color)] hover:text-blue-400">
                  <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {/* :::linkedin */}
                <a href="#linkedin" className="m-2 p-1 inline-flex justify-center items-center text-[var(--primary-color)] hover:text-blue-400">
                  <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
