...
const Contact16 = () => {
  return (
    <div className="relative my-8 mx-auto w-full max-w-7xl  bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100 text-white overflow-hidden">
      <div className="grid grid-cols-6 md:grid-cols-5">
          ...
          <div className="mt-8 sm:mt-16 flex items-center">
            ...
            <div className="ml-3 flex space-x-2">
              ...
              <a href="#facebook" className="p-1 inline-flex justify-center items-center text-blue-300 hover:text-blue-400">
                <svg className="flex-shrink-0 w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              {/* :::twitter */}
              <a href="#twitter" className="m-2 p-1 inline-flex justify-center items-center text-blue-300 hover:text-blue-400">
              ...
              {/* :::intagram */}
              <a href="#instagrap" className="m-2 p-1 inline-flex justify-center items-center text-blue-300 hover:text-blue-400">
                <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              {/* :::linkedin */}
              <a href="#linkedin" className="m-2 p-1 inline-flex justify-center items-center text-blue-300 hover:text-blue-400">
                <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="col-span-full sm:col-span-3">
          {/* Embed Google map */}
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6214.8211700506645!2d76.42882559361558!3d10.17761954352797!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0807bfa8906d61%3A0x11ad08dbd85357dc!2sAdi%20Shankara%20Institute%20of%20Engineering%20and%20Technology%20Kaladi!5e0!3m2!1sen!2sin!4v1672305829425!5m2!1sen!2sin" 
