...
const PrizeMoney = () => {
  return (
    <a className="group px-2.5 pb-1 flex flex-row justify-center relative text-3xl mt-10 md:mt-0 md:text-6xl bg-clip-text bg-gradient-to-br from-pc to-sc font-bold no-underline whitespace-nowrap outline-none overflow-hidden " href="#url">
      {/* Text slide */}
