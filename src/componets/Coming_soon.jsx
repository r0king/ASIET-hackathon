    ...
    <div className="relative w-full bg-[#171717]">
      <div className="flex flex-col items-center max-w-4xl min-h-screen py-16 mx-auto text-center sm:justify-center">
        ...
        <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
          <p className="text-4xl font-extrabold text-center text-[var(--primary-color)] text-opacity-40 sm:text-6xl md:text-7xl">Great Things</p>
          <p className="font-[#171717] tracking-widest text-center text-[var(--primary-color)] text-opacity-40 uppercase text-8xl sm:text-10xl md:text-12xl">Take Time</p>
        </div>
