...
const Tagline = () => {
  ...
  useEffect(() => {
    if (isElementOverflowing(document.getElementById("glitch-te2"))) {
  ...
  const marq = React.useRef();
  return (
    <div className="text-center">
      {isOverflowing && marq.stop()}
      <marquee id="marq"> <h1
      className="relative max-w-screen-xl text-white text-4xl capitalize font-bold tracking-widest mt-6 mb-10"
      data-text="glitch"
    >
      <span
        id="before-te2"
