    ...
    useEffect(() => {
        ...
        const setKeyframesRules1 = (n, start = 0) => {
            ...
            for (let i = start; i <= n; i++) {
                ...
                steps = steps.concat(`${percent}% { clip: rect(${random1}, 9999px, ${random2}, 0); transform: skew(${random3}) } `)
            }
            return steps
        }
        ...
        after.style.animation = "glitch-effect-1 5s infinite linear alternate-reverse"
        before.style.animation = "glitch-effect-2 1s infinite linear alternate-reverse"
